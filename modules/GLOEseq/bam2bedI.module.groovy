bam2bedI = {
	doc title: "bam2bedI",
		desc:  "Convert BAM file to bed and the perl code identifies the first base before the 5' of each read on the opposite strand (indirect mode)",
		constraints: "none.",
	...
	transform(".bam") to (".bed") {
		exec """
			...
			perl ${TOOL_GLOEseq}/indirect_mode.pl ${output.prefix}.reads.bed | sort -k1,1 -k2,2n -k 6 - |  awk '(\$2 >= 0)' > ${output.prefix}.sites.bed &&
