	...
	transform("*.fastq.gz") to (".trimmed.fastq.gz") {
		exec """
            ...
            module load cutadapt/${CUTADAPT_VERSION} &&
                        ...
                        cutadapt $CUTADAPT_THREADS $CUTADAPT_FLAGS --output=\${TMPDIR}/${SAMPLENAME_BASE_PRUNED}.R1.trimmed.fastq.gz --paired-output \${TMPDIR}/${SAMPLENAME_BASE_PRUNED}.R2.trimmed.fastq.gz $input1 $input2 1> ${TRIM_LOGS}/${SAMPLENAME_BASE_PRUNED}.cutadapt.log &&
