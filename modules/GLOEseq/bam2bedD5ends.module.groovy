bam2bedD5ends = {
	doc title: "bam2bedD5ends",
		desc:  "Convert BAM file to bed and the perl code identifies the first base of each read on the same strand (direct mode)",
		constraints: "none.",
	...
	transform(".bam") to (".bed") {
		exec """
			...
			perl ${TOOL_GLOEseq}/direct_mode_5ends.pl ${output.prefix}.reads.bed | sort -k1,1 -k2,2n -k 6 - |  awk '(\$2 >= 0)' > ${output.prefix}.sites.bed &&
